...
-- 기존 코드
export type Object = {
 SpeedLayeredValue: LayeredValue.LayeredValue<number>,
...
-- {type} 에 쓸 양식
### SpeedLayeredValue
LayeredValue<number> -- LayeredValue.LayeredValue 는 서로 동일하므로, 모듈 이름 생략
...
```luau
-- 기존 코드
Object.SpeedLayeredValue = LayeredValue.new(...)
